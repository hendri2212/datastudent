    ...
    <div class="min-h-screen bg-neutral-50/50 p-6 dark:bg-neutral-900/50">
        <div class="mx-auto max-w-7xl space-y-6">
            ...
            <div class="rounded-xl border bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                ...
                <div
                    class="flex flex-col gap-3 border-b p-4 dark:border-neutral-800 lg:flex-row lg:items-center lg:justify-between">
                                    ...
                                    <template v-if="activeTab === 'active'">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                <DropdownMenuItem class="text-rose-600 dark:text-rose-400"
                                    ...
                                    <template v-else>
                                        <div class="flex items-center justify-end gap-2">
                                            <Button size="sm" variant="outline"
                                                ...
                                                :disabled="restoringId === item.id" @click="submitRestore(item)">
                ...
                <div
                    class="flex flex-col gap-3 border-t p-4 dark:border-neutral-800 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-4 text-xs text-neutral-500">
                        <span>
                            Menampilkan <strong>{{ startIndex }}</strong> - <strong>{{ endIndex }}</strong> dari
                            <strong>{{
                                filteredClassrooms.length }}</strong> data
                        </span>
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <template v-for="page in totalPages" :key="page">
                            <Button v-if="page === 1 || page === totalPages || Math.abs(page - currentPage) <= 1"
                                ...
                                class="h-8 min-w-8 px-2 text-xs" @click="currentPage = page">
                                {{ page }}
                            </Button>
                            <span v-else-if="page === 2 && currentPage > 3"
                                class="px-1 text-xs text-neutral-400">...</span>
                            <span v-else-if="page === totalPages - 1 && currentPage < totalPages - 2"
                                class="px-1 text-xs text-neutral-400">...</span>
                        </template>
        ...
        <DialogContent>
            ...
            <form @submit.prevent="submitAdd" class="space-y-4">
                ...
                <div v-if="addForm.major_id"
                    ...
                    Sistem akan otomatis menentukan rombel berikutnya untuk <strong>{{ addForm.level }} {{
                        selectedMajorCode
                        }}</strong>.
                </div>
    ...
    <Dialog v-model:open="isForceDeleteModalOpen">
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription>
                    Apakah Anda yakin ingin menghapus kelas <strong>{{ selectedClassroom?.name }}</strong> secara
                    permanen?
        ...
        <DialogContent class="sm:max-w-md">
            ...
            <div v-if="selectedClassroom" class="space-y-4 py-2">
                ...
                <div class="border-t pt-3 dark:border-neutral-800">
                    <span class="text-xs font-semibold uppercase tracking-wider text-neutral-500">Distribusi
                        Agama</span>
